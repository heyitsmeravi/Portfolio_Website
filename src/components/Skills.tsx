...
const Skills = ({ darkMode }: SkillsProps) => {
    ...
    return (
        <section id="skills"
            ...
            className="py-12 scroll-mt-12 relative overflow-hidden">
            <div className="relative overflow-hidden">
                <div className="container px-5 mx-auto">
                    <div className="text-center mb-20"
                        ...
                        <p className='text-center font-medium sm:font-semibold text-base sm:text-lg leading-relaxed max-w-3xl mx-auto'
                            style={{
                                color: darkMode ? '#d1d5db' : '#4b5563'
                            }}>
                            I engineer scalable, responsive web applications utilizing modern technologies. Whether crafting engaging user interfaces with React or architecting robust APIs with Node.js, my core focus remains on performance, clean code, and solving real-world problems effectively.
                        </p>
                    </div>
