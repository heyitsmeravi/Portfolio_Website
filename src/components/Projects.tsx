...
const Projects=({darkMode})=>{
    ...
    return(
        <section id="projects" 
        className={`relative py-24 ${darkMode?'bg-gray-900':'bg-gray-50'}`}>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-12 '>
                        {
                            projects.map((project,index)=>(
                                <div key={project.id}
                                style={{background:darkMode?'linear-gradient(to right, #1f2937, #111827)':'linear-gradient(to right, #ffffff, #f9fafb)',
                                    ...
                                    <div className='p-4'>
                                        ...
                                        <div className='flex flex-wrap gap-1.5 mb-4'>
                                            {project.tags.map((tag,idx)=>(
                                                <span key={idx}
                                                style={{backgroundColor:darkMode?'#347151':'#f3f4f6',
                                        ...
                                        <div className='flex gap-2 '>
                                            <a href="#" style={{backgroundColor:darkMode?'#374151':'#f3f4f6',
                                            ...
                                            data-aos='zoom-in'
                                            data-aos-delay='300'>
                                                <FaGithub className='text-sm'/><span>Code</span>
                                            </a>
                                            <a href="#" style={{background:'linear-gradient(to right, #f97316, #f59e0b)'
                                            }}
                                            className='flex-1 flex items-center justify-center text-white gap-1.5 px-3 py-2 text-sm rounded-lg hover:shadow-lg hover:shadow-orange-500/50 '
                                            data-aos='zoom-in'
                                            data-aos-delay='300'>
                                                <FaExternalLinkAlt className='text-sm'/><span>Demo</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
